...
def drones_fly_goal():
    ...
    while not rospy.is_shutdown():
        ...
        if (i/100)%4 == 0:
            ...
            pose_vel_ctrl1.linear.y = 6
            pose_vel_ctrl2.linear.x = 3
            pose_vel_ctrl2.linear.y = 3
        elif (i/100)%4 == 1:
            pose_vel_ctrl1.linear.x = 6
            pose_vel_ctrl1.linear.y = 3
            pose_vel_ctrl2.linear.x = 7
            pose_vel_ctrl2.linear.y = 7
        elif (i/100)%4 == 2:
            pose_vel_ctrl1.linear.x = 3
            pose_vel_ctrl1.linear.y = 3
            pose_vel_ctrl2.linear.x = 7
